...
namespace 悲愴三国志Zero2_1.Code {
    ...
    public enum Phase { Starting, Planning, Execution };
    ...
    public enum EArea {
      襄平, 番汗, 朝鮮, 陽楽, 土垠, 薊, 代, 南皮, 魯, 濮陽, 晋陽, 鄴, 劇, 淮陰, 陰陵, 彭城, 離石, 平陽, 洛陽, 平輿, 酸棗, 長安, 金城, 武威, 居延, 敦煌, 宛, 襄陽, 武昌, 鄂, 臨沅, 臨湘, 泉陵, 郴,
      建業, 秣陵, 舒, 鄱陽, 南城, 山陰, 東侯官, 番禺, 合浦, 龍編, 日南, 南鄭, 房陵, 葭萌, 綿竹, 魚復, 成都, 漢嘉, 涪陵, 朱提, 邛都, 且蘭, 滇池, 西随, 不韋, 緬甸, 哀牢, 南越, 朱崖, 台北, 台南,
      伊吾, 湔氐, 汶江, 羌, 西海, 朔方, 臨河, 北地, 鮮卑, 弾汗, 丁零, 堅昆, 烏桓, 白狼, 沃沮, 丸都, 目支, 首里
    };
    public enum ECountry {
      漢, 董卓, 袁紹, 袁術, 曹操, 孫堅, 公孫瓚, 陶謙, 韓遂, 劉焉, 公孫度, 劉虞, 焦和, 王叡, 劉表, 蘇固, 曹寅, 張咨, 劉岱, 韓馥, 張超, 張楊, 士燮, 馬相, 黒山賊, 濊,
      魏, 呉, 蜀漢, 燕, 南蛮, 北匈奴, 羌, 氐, 南匈奴, 鮮卑, 烏丸, 高句麗, 沃沮, 馬韓, 南越, 琉球
    };
	}
}
