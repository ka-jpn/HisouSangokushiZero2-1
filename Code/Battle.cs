...
namespace 悲愴三国志Zero2_1.Code {
	internal static class Battle {
		...
		internal static AttackJudge JudgeAttack(decimal attackRank,decimal defenseRank,bool defenseSideFocusDefense) => MyRandom.GenerateDouble(0,thresholdMax).MyApplyF(rand => Enum.GetValues<AttackJudge>().FirstOrDefault(v => rand<=GetThreshold(v,(double)(attackRank-(defenseRank+(defenseSideFocusDefense ? 2 : 0))))));
